describe('Login Page Test', () => {
    ...
    it('Cek perilaku pengguna umum login akun tanpa menginputkan kredensial', () => {
    ...
    it('Cek perilaku pengguna umum login akun dengan kredensial yang belum terdaftar', () => {
    ...
    it('Cek perilaku pengguna umum login akun dengan kredensial yang valid', () => {
        const user = Cypress.env('users')['general_user'];
