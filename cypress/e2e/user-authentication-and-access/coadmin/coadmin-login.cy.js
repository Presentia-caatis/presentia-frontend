describe('Login Page Test', () => {
    ...
    it('Cek perilaku co-admin sekolah login akun tanpa menginputkan kredensial', () => {
    ...
    it('Cek perilaku co-admin sekolah login akun dengan kredensial yang belum terdaftar', () => {
    ...
    it('Cek perilaku co-admin sekolah login akun dengan kredensial yang valid', () => {
        const user = Cypress.env('users')['coadmin'];
