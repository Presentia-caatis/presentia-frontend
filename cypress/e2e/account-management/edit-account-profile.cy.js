describe('Edit Account Profile Test', () => {
  ...
  roles.forEach((role) => {
    it(`Cek perilaku ${role === 'general_user' ? 'pengguna umum'
      ...
      const inputsToCheck = [{
          selector: 'input[placeholder="Masukkan Email"]',
          assert: 'exist',
          disabled: true
        },
        {
          selector: 'input[placeholder="Masukkan Username"]',
          assert: 'exist',
          disabled: false
        },
        {
      ...
      const allNames = ["Presentia admin testtt", "Presentia admin testt", "Presentia admin testttttt"];
