    ...
    roles.forEach((role) => {
        it(`Cek perilaku ${role === 'staf' ? 'staf sekolah'
            : role === 'admin' ? 'admin sekolah'
                ...
                melihat statistik data statistik data kehadiran berdasarkan status berupa absen, tepat waktu, dan terlambat.dan melihat statistik data siswa berdasarkan status berupa aktif dan tidak aktif `, () => {
            cy.loginAs(role);
            ...
            buttons.forEach(({
                ...
                const studentAttendanceChart = [{
                        title: 'Perbandingan Kehadiran Hari Ini',
                        noDataText: 'Tidak Ada Kehadiran Hari Ini'
                    },
                    {
                        title: 'Statistik Kehadiran Harian',
                ...
                studentAttendanceChart.forEach(({
                    title,
                    noDataText
                }) => {
