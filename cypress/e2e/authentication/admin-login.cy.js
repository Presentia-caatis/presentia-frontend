describe('Login Page Test', () => {
    ...
    it('Cek perilaku user login akun tanpa menginputkan kredensial', () => {
    ...
    it('Cek perilaku user login akun dengan kredensial yang belum terdaftar', () => {
    ...
    it('Cek perilaku user login akun dengan kredensial yang valid', () => {
        const user = Cypress.env('users')['tester'];
