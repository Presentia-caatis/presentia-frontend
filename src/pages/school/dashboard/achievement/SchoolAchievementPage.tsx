...
const SchoolAchievementPage = () => {
    ...
    const [achievementList, setAchievementList] = useState<AchievementData[]>([
        { id: 1, name: 'Pencapaian A', description: "menang", code: 'A28', grade: 90, status: 'Active' },
        { id: 2, name: 'Pencapaian B', description: "menang", code: 'A28', grade: 90, status: 'Active' }
    ]);
            ...
            <div className="card">
                <div className="flex justify-content-between p-4 card">
                    <div className="flex gap-2">
                        <Button icon="pi pi-plus" severity="success" label="Pencapaian" onClick={() => setShowAddDialog(true)} />
                ...
                <DataTable
                    ...
                    header={
                        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                            <h5 className="m-0">Daftar Pencapaian</h5>
                ...
                >
                    ...
                    <div className="field">
                        <label htmlFor="code">Kode Pencapaian</label>
                        <InputText
                            id="code"
...
export default SchoolAchievementPage;
