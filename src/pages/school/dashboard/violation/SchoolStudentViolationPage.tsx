...
const SchoolStudentViolationPage = () => {
    ...
    const [studentList, setStudentList] = useState<StudentData[]>([
        {
            ...
            status: 'Active',
            achievement: [
                { id: 1, name: 'Pelanggaran A', description: "Menang", code: 'A28', score: 90 },
                { id: 2, name: 'Pelanggaran B', description: "Menang", code: 'A29', score: 80 }
            ]
        },
        {
            name: 'Mon',
            ...
            status: 'Active',
            achievement: [
                { id: 3, name: 'Pelanggaran C', description: "Lulus", code: 'A30', score: 85 }
            ]
        },
        {
            name: 'Staal',
            ...
            <div className="card">
                <div className='flex justify-content-between p-4 card'>
                    <div className='flex gap-2'>
                        <Button icon="pi pi-plus" severity='success' label='Pelanggaran Siswa' onClick={() => {
                ...
                <Dialog visible={showAddDialog} style={{ width: '450px' }} onHide={() => {
                    ...
                    <div className='field'>
                        <label htmlFor="achievement">Pelanggaran</label>
                        <Dropdown
                ...
                >
                    <DataTable
                        ...
                        header={
                            <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                                <h5 className="m-0">Data Pelanggaran SMAN 24</h5>
                                <span className="block mt-2 md:mt-0 p-input-icon-left">
                                    <i className="pi pi-search" style={{ paddingLeft: '8px' }} />
                                    <InputText className='py-2 pl-5' placeholder="Search..." />
                                </span>
                        ...
                        paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"
                        currentPageReportTemplate="Showing {first} to {last} of {totalRecords} achievements"
                        footerColumnGroup={
                            <ColumnGroup>
                                <Row>
...
export default SchoolStudentViolationPage;
